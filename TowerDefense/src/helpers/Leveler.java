...
public class Leveler {
	public static String mapFolderPath = System.getProperty("user.dir") + "\\maps\\";
	...
	public static void saveMap(String mapName, TileGrid grid) {
		...
		try {
			File file = new File(mapFolderPath, mapName + ".map");
	...
	public static TileGrid loadMap(String mapName) {
		...
		try {
			BufferedReader br = new BufferedReader(new FileReader(mapFolderPath + mapName));
